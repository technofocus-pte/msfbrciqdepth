...
![Screenshot of the time selector.](./media/image114.png)

6.  Observe the time series data that's visible from
    different *Freezer* entity instances.

![Screenshot of the time series tiles.](./media/image115.png)
...
![Screenshot of filtering the components.](./media/image126.png)
